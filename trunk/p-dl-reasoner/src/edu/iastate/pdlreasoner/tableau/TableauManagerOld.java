...
public class TableauManagerOld {
	...
	private static final Logger LOGGER = Logger.getLogger(TableauManagerOld.class);
	...
	private Queue<TableauMessage> m_ReceivedMsgs;
	...
	public TableauManagerOld(OntologyPackage pack) {
		...
		m_Token = null;
		m_ReceivedMsgs = new LinkedList<TableauMessage>();
...
//	}
	...
	public void receive(TableauMessage msg) {
